...
namespace LegitBankApp.Menu
{
 ...
 if(pass1 == security)
 {
           ...
           // _iAdminManager.ReWriteToFile();
            System.Console.WriteLine("Enter 0 to opt out");
            int x;
 ...
 {
    System.Console.WriteLine("go to the organization to get your pass");
 }
 ...
 if(pass1 == security)
 {
            ...
            System.Console.WriteLine("go to Organization to get pass");
        }
     }
 ...
 ################################################################################");
...

        {
            ...
            string refNum = " ";
            if(withdraw <Transaction._accountBalance )
            {
            ...
            {
                System.Console.WriteLine($"You have low balance,your balance is: {Transaction._accountBalance }");
            }
...

        {
            ...
            string time = DateTime.Now.ToString("dddd,dd MMMM yyyy HH:mm:ss");
            string refNum = " ";
            if(airtime < Transaction._accountBalance)
            {
            ...
            {
                System.Console.WriteLine($"You can't make transaction more than {Transaction._accountBalance}");
            }
        ...
        {
            System.Console.WriteLine("Enter the account number to delete transaction");
            string accountNum = Console.ReadLine();

            var transact = _iTransactionManager.GetTransaction(accountNum);
            if (transact != null)
            {

                System.Console.WriteLine($"{transact._firstName}\t{transact._lastName}\t{transact._accountNumber}");
            }
            else
            {
                System.Console.WriteLine("error");
            }
            //System.Console.WriteLine($"{transact._firstName}\t{transact._lastName}\t{transact._accountNumber}\t{Transaction._accountBalance}\t{Transaction._airtimeAmount}\t{Transaction._depositAmount}\t{Transaction._withdrawalAmount}");
