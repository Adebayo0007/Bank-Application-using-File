...
namespace LegitBankApp.Implementations
{
    ...
    {
        public string _transactionFilePath = "./File/TransactionFile.txt";
        ...
        {
            System.Console.WriteLine("Enter your account number to delete transaction");
            string accountNumber = Console.ReadLine();
            var transaction = GetTransaction(accountNumber);
            if (transaction != null)
            {
